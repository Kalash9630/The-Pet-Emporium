    ...
    <div className="row">
      <div>
        ...
        <div className="col-md-8 container-fluid mt-5" style={{fontSize:"20px"}}>
          ...
          <p>
          <div><b>- Convenient Location: </b></div> Our location is easily accessible, making drop-off and pick-up a breeze for busy pet owners.
          </p>
          <p>
          <div><b>- Clean and Safe Facilities: </b> </div>
          We maintain a clean and secure environment to ensure your pet's safety and comfort at all times.
          </p>
